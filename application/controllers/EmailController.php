...
class EmailController extends CI_Controller
{
    ...
    public function enviarCorreo($idCandidato)
    {
        ...
        $candidato = $this->getDataCandidato($idCandidato);
        ...
        // Plantilla HTML para el correo con datos dinámicos
        $mensaje = '
        <!DOCTYPE html>
        <html lang="es">
        <head>
        ...
        <body>
            <div class="email-container">
                ...
                <div class="email-body">
                    <p>Estimado/a <strong>' . htmlspecialchars($candidato->Nombres) . '</strong>,</p>
